...
def create_task_overview_visualization(input_file_path: Path, output_file_path: Path, show_plot: bool = False):
...
if __name__ == "__main__":
    print("--- RUNNING TASK VISUALIZATION SCRIPT IN STANDALONE TEST MODE ---")
    ...
    TEST_INPUT_PATH = ANALYSIS_DATA_DIR_TEST / "jobs_ch_tasks_overview.csv"
    TEST_OUTPUT_PATH = REPORT_DIR_TEST / "required_tasks_overview.png"
    ...
    if not os.path.exists(TEST_INPUT_PATH):
        ...
        print("Please ensure your Tasks Analysis script has generated this file first.")
        sys.exit(1)

    # Run the jobs_taks_vis script
